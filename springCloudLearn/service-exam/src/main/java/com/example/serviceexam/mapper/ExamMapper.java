...
public interface ExamMapper {
    ...
    @Select("select exam.* from exam left join exam_to_teacher as et on exam.examId = et.examId WHERE et.userId= #{userId}")
    List<Exam>selectExamByTeacherId(@Param("userId")int userId);
