...
public interface PaperMapper {
    ...
    int getMaxPaperId();
    @Insert("insert into paper(paperId,gradeId,subjectId)values(#{paperId},#{gradeId},#{subjectId})")
    ...
    void addQuestion(@Param("questionId")int questionId,@Param("paperId")int paperId,@Param("score")int score);
}
